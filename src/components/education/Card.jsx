...
const dimensionClass = "w-80 h-80"; // Customize width and height as needed

function Card({ institution, degree, duration, coursework }) {
    return (
        <div className={`${baseCardClass} ${hoverClass} ${dimensionClass} flex flex-col justify-between`} style={{ backgroundColor: '#f5f5f5' }}>
