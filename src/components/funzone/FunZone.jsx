...
<ul className='max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400'>
  <li className='p-1'>Scored enough grades in High School to not be disowned by family</li>
  <li className='p-1'>Scored enough grades during Entrance Exams to not be thrown out of the Engineering race</li>
  <li className='p-1'>Survived one of the worst Engineering curriculums for 4 years</li>
  <li className='p-1'>Made great friends during undergrad</li>
  <li className='p-1'>Survived a culture shock during 2023</li>
  <li className='p-1'>Have been cooking great food since 2022</li>
</ul>
</div>
